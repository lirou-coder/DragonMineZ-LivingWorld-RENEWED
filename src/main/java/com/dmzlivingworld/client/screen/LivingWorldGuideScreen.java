...
public final class LivingWorldGuideScreen extends Screen implements LivingWorldScreenMarker {
    ...
    private static final List<Chapter> CHAPTERS = List.of(
            chapter("Getting Started", "The basics",
                    ...
                    "* L — open Living World.",
                    "* Shift + Right-click a Living World fighter — open their character panel.",
            ...
            chapter("People", "Characters you have met",
                    ...
                    "* Shift + Right-click shows their current identity, story, combat information and available actions.",
            ...
            chapter("Fusion & Meditation", "Shared Dragon Mine Z systems",
                    "* Shift + Right-click → Fusion starts a compatible Fusion Dance with that fighter.",
            ...
            chapter("Controls & Settings", "Quick reference",
                    "* L — Living World menu.",
                    "* Shift + Right-click — inspect a fighter.",
                    "* M — meditation.",
                    "* ? — this guide.",
