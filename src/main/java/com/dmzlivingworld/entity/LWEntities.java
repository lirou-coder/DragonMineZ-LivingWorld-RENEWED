...
public final class LWEntities {
    ...
    public static final RegistryObject<EntityType<AmbientFighterEntity>> AMBIENT_FIGHTER =
            ENTITY_TYPES.register(
                    "ambient_fighter",
                    () -> EntityType.Builder.of(
                                    AmbientFighterEntity::new,
    ...
    public static final RegistryObject<EntityType<WorldMenaceFighterEntity>> WORLD_MENACE_FIGHTER =
            ENTITY_TYPES.register(
                    "world_menace_fighter",
                    () -> EntityType.Builder.of(
                                    WorldMenaceFighterEntity::new,
                                    MobCategory.MONSTER
                            )
                            .noSummon()
                            .sized(0.62F, 1.86F)
