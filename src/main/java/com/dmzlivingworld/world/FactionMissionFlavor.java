...
public final class FactionMissionFlavor {
    ...
    private static final IntelScenario[] INTEL = new IntelScenario[]{
            scenario("shift_change", "Shift Change", "Observe a guard rotation and learn when the perimeter is thinnest.",
            ...
            scenario("supply_audit", "Supply Audit", "Watch a guarded supply count and identify what the faction is short on or stockpiling.",
            ...
            scenario("courier_handoff", "Courier Handoff", "Identify a messenger route and learn who receives sensitive field reports.",
            ...
            scenario("officer_briefing", "Officer Briefing", "Listen in on a field officer assigning priorities to a patrol element.",
            ...
            scenario("training_rotation", "Training Rotation", "Observe a combat drill to estimate readiness, favored tactics, and weak links.",
            ...
            scenario("perimeter_relay", "Perimeter Relay", "Map a short-range signal relay and identify the faction's alarm response pattern.",
    ...
    private static final String[] PATROL_JOIN = keyed("patrol.join",
    ...
    private static final String[] PATROL_TRAVEL = keyed("patrol.travel",
    ...
    private static final String[] RECOVERY_JOIN = keyed("patrol.recovery_join",
    ...
    private static final String[] PATROL_AMBUSH = keyed("patrol.ambush",
    ...
    private static final String[] PATROL_RESUME = keyed("patrol.resume",
    ...
    private static final String[] PATROL_FINISH = keyed("patrol.finish",
    ...
    private static final String[] PATROL_HARD_FINISH = keyed("patrol.hard_finish",
    ...
    private static IntelScenario scenario(String key, String name, String brief, String[] arrival, String[] detected,
                                          String[] searching, String[] observed, String[] reportClean, String[] reportBloody) {
        return new IntelScenario(name, brief,
                keyed("intel." + key + ".arrival", arrival),
                keyed("intel." + key + ".detected", detected),
                keyed("intel." + key + ".searching", searching),
                keyed("intel." + key + ".observed", observed),
                keyed("intel." + key + ".report_clean", reportClean),
                keyed("intel." + key + ".report_bloody", reportBloody));
    }

    private static String[] keyed(String group, String... lines) {
        String[] localized = new String[lines.length];
        for (int i = 0; i < lines.length; i++)
            localized[i] = LWLang.speechKey("dialogue.faction_mission." + group + "." + i, lines[i]);
        return localized;
    }
}
